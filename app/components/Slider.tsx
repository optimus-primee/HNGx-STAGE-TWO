  ...
  return (
    <div className="">
      {movies.map((movie: IMovie, index: number) => {
        return (
          <div className="z-1 w-[100%] sm:h-[80%]  overflow-hidden" key={index}>
            {index === current && (
              <div className="bg-gradient-to-b from-black via-transparent to-transparent absolute top-0 left-0 w-[100%] h-[80vh] ">
                <Image
